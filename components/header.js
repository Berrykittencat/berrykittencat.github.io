...
<header class="ui fluid segment">
    ...
    <nav class="ui horizontal bulleted link large list">
        <a id="nav_0" class="item">Overzicht</a>
        <a id="nav_1" class="item">Accomodatie</a>
        <a id="nav_2" class="item">Faciliteiten</a>
        <a id="nav_3" class="item">Activiteiten</a>
        <a id="nav_4" class="item">Restaurants & Shops</a>
        <a id="nav_5" class="item">Trips</a>
        <a id="nav_6" class="item">Prijzen</a>
        <a id="nav_7" class="item">Plattegrond</a>
    </nav>
</header>
